"""
Django settings for DM_dashboard project.
...
# SECRET_KEY = 
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '3*xisb#-or&hn8mc&=-99m*q(d)gssp5k+enq+at*f@z^uxqzz')
...
ROOT_URLCONF = 'DM_dashboard.urls'
...
WSGI_APPLICATION = 'DM_dashboard.wsgi.application'
